...
const Home = () => {
  ...
  return (
    <div className="h-full  flex w-screen flex-col ">
      <img
        src={heroBG}
        className="absolute w-screen  object-contain -z-10"
      />
      <Navbar />
      {/* <Countdown /> */}
      ...
      <div className=" flex items-center justify-between px-[124px] pt-10 bg-white">
        <div className="flex flex-col w-1/2 gap-10 justify-between">
          ...
          <div className="  text-black text-xl font-normal font-['Poppins']">
            Welcome to the divine realm of Audhaya and Ram Lala NFTs, where
            we merge the timeless tradition of Sanatan Dharma with modern
            technology. We believe in spreading the essence of our ancient
            culture to the world, and to celebrate this, we are offering
            free NFTs that encapsulate the spirit of Shri Ram and the
            legendary Ramayana.
          </div>
          ...
          <div className="">
            ...
            <span className="text-black text-xl font-normal font-['Poppins']">
              In our quest to bridge the ancient and the contemporary, we
              embark on a journey to create a unique space where digital
              art meets spirituality. We not only provide free NFTs as
              tokens of devotion but also have exciting plans for the
              future to enhance this digital pilgrimage.
            </span>
          </div>
